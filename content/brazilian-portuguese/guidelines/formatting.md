...
- [Folha de dicas padrão do Markdown](https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet)
- [Opções de formatação personalizada usando shortcodes](/guidelines/shortcodes/)

## Exemplos de formatação

Este tema inclui várias opções para personalizar a aparência do seu site. Abaixo, você pode encontrar vários exemplos de uso, que incluem a sintaxe a ser usada seguida do que realmente é mostrado em uma página quando você usa essa sintaxe.

### Alertas

#### Informações

    {{</* alert theme="info" */>}}**Isso** é uma info {{</* /alert */>}}
...
#### Aviso
    ...
    {{</* alert theme="warning" */>}}**Tome cuidado** é um aviso{{</* /alert */>}}
...
### Botões
    ...
    {{</* button href="https://nuevofoundation.org" */>}} Vá para a Nuevo Foundation {{</* /button */>}}

{{<button href="https://google.com" >}} Vá para a Nuevo Foundation {{< /button >}}

#### Botão de sucesso

    {{</* button href="https://nuevofoundation.org" theme="success" */>}} Success {{</* /button */>}}

{{<button href="https://google.com" theme="success">}} Successo {{< /button >}}
...
#### Aviso de informação
    ...
    {{</* notice info */>}}
    Um aviso de isenção de informações
    {{</* /notice */>}}
...
#### Aviso de Dica
    ...
    {{</* notice tip */>}}
    Um aviso de isenção de responsabilidade de dica
    {{</* /notice */>}}
