...
![Não foi possível carregar a imagem](../img/adafruit-define-variables.png?classes=border,shadow)
![Não foi possível carregar a imagem](../img/adafruit-make-variable-dialog.png?classes=border,shadow)
![Não foi possível carregar a imagem](../img/adafruit-variables-created.png?classes=border,shadow)
...
![Não foi possível carregar a imagem](../img/adafruit-set-variable-block.png?classes=border,shadow)
...
![Não foi possível carregar a imagem](../img/adafruit-analog-read-pin.png?classes=border,shadow)
![Não foi possível carregar a imagem](../img/adafruit-analog1-complete.png?classes=border,shadow)
...
![Não foi possível carregar a imagem](../img/adafruit-analog2-complete.png?classes=border,shadow)
...
![Não foi possível carregar a imagem](../img/adafruit-if-then-block.png?classes=border,shadow)
...
![Não foi possível carregar a imagem](../img/adafruit-comparison-block.png?classes=border,shadow)
...
![Não foi possível carregar a imagem](../img/adafruit-threshold-value.png?classes=border,shadow)
...
![Não foi possível carregar a imagem](../img/adafruit-play-sound-block.png?classes=border,shadow)
...
![Não foi possível carregar a imagem](../img/adafruit-complete-workspace.png?classes=border,shadow)
...
![Não foi possível carregar a imagem](../img/adafruit-lights-added.png?classes=border,shadow)
