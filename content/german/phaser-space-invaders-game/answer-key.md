---
title: "Antwortschlüssel - Phaser Space Invaders Spiel"
...
create(){
    ...
    // lösche deinen vorherigen Hintergrundcode und erstelle ihn erneut als Tile-Sprite
...
playerShoot(){
    ...
    if (Phaser.Input.Keyboard.JustDown(this.spacebar)) {
        if(this.player.active) {
    		...
    		this.projectiles.add(playerBullet); // zur Gruppe hinzufügen
    	}
    }
}
...
hitEnemy(projectile, enemy) {
	...
	this.score += 15;
	this.scoreText.text = "Punkte " + this.score;
}
```
