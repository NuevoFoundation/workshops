...
![Bild kann nicht geladen werden](../img/adafruit-define-variables.png?classes=border,shadow)
![Bild kann nicht geladen werden](../img/adafruit-make-variable-dialog.png?classes=border,shadow)
![Bild kann nicht geladen werden](../img/adafruit-variables-created.png?classes=border,shadow)
...
![Bild kann nicht geladen werden](../img/adafruit-set-variable-block.png?classes=border,shadow)
...
![Bild kann nicht geladen werden](../img/adafruit-analog-read-pin.png?classes=border,shadow)
![Bild kann nicht geladen werden](../img/adafruit-analog1-complete.png?classes=border,shadow)
...
![Bild kann nicht geladen werden](../img/adafruit-analog2-complete.png?classes=border,shadow)
...
![Bild kann nicht geladen werden](../img/adafruit-if-then-block.png?classes=border,shadow)
...
![Bild kann nicht geladen werden](../img/adafruit-comparison-block.png?classes=border,shadow)
...
![Bild kann nicht geladen werden](../img/adafruit-threshold-value.png?classes=border,shadow)
...
![Bild kann nicht geladen werden](../img/adafruit-play-sound-block.png?classes=border,shadow)
...
![Bild kann nicht geladen werden](../img/adafruit-complete-workspace.png?classes=border,shadow)
...
![Bild kann nicht geladen werden](../img/adafruit-lights-added.png?classes=border,shadow)