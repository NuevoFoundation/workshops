...
For drawing the lines, go ahead and use the functions you previously used or drawing the line. To turn left, you need to use the *turtle.left()* function. To turn 90 degrees left, you need to pass 90 as the argument to the *left* function: *turtle.left(90).*  Write the code and run it. Be sure to remove the ‘#’ from the line that calls draw_square to uncomment it! Check if the turtle draws a square.
