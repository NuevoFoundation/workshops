...
{{% notice note %}}
This answer key is currently provided in English, matching the AIML patterns and bot responses used throughout the Korean lessons. A Korean translation of the explanatory text is welcome.
{{% /notice %}}
