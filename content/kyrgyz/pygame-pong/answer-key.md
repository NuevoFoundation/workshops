---
title: "Pygame Pong оюну - Жооп ачкычы"
...
```python
WIDTH = 800 
# WIDTHтин мааниси мурда 20 болгон
```
...
```python
self.paddles.append(Paddle(  # Сол тарабы үчүн paddle
      self.BALL_VELOCITY,
      pygame.K_w,
      pygame.K_s,
      0,
...
```python
 self.paddles.append(Paddle(  # Оң тарабы үчүн paddle
      self.BALL_VELOCITY,
      pygame.K_UP,
      pygame.K_DOWN,
