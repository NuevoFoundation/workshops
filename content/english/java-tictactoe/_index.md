...
You will need basic Java knowledge from the workshop [Java: Basics](https://workshops.nuevofoundation.org/java-basics/) as we will assume you to know about variables, operators, classes, and arrays during the exercises.
