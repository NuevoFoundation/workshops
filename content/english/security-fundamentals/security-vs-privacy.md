...
{{< figure src="../img/teacher.png" alt="Illustration of a teacher explaining security concepts" width="40%" >}}
### Security
...
{{< figure src="../img/security-vs-privacy.png" alt="Diagram comparing security and privacy with three outcomes: both maintained, privacy compromised, and both compromised" width="60%" >}}
