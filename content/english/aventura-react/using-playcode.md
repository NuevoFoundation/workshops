...
Sharky will teach you how to use React and build your trip through Costa Rica. Today we are going to start an adventure creating a Costa Rica app with React.
React lets us create screens using something similar to HTML.
...
<iframe src="https://playcode.io/react" title="Using Playground - PlayCode editor" width="100%" height="600" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen></iframe>
