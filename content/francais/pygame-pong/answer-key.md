---
title: "Jeu Pong avec Pygame - Clé de Réponses"
...
```python
WIDTH = 800 
# La valeur de WIDTH était précédemment 20
```
...
```python
self.paddles.append(Paddle(  # La raquette gauche
      self.BALL_VELOCITY,
      pygame.K_w,
      pygame.K_s,
      0,
...
```python
 self.paddles.append(Paddle(  # La raquette droite
      self.BALL_VELOCITY,
      pygame.K_UP,
      pygame.K_DOWN,
