```markdown
---
title: "Clé de Réponse - Jeu Phaser Space Invaders"
...
create(){
    ...
    // supprimez votre précédent code de fond et recréez-le comme une tuile sprite
...
```javascript
create(){
    this.player.body.setCollideWorldBounds(true); // le joueur ne peut pas sortir de l'écran
...
playerShoot(){
    ...
    if (Phaser.Input.Keyboard.JustDown(this.spacebar)) {
        if(this.player.active) {
    		...
    		this.projectiles.add(playerBullet); // ajouter au groupe
    	}
    }
}
