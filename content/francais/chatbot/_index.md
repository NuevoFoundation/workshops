...
<p style="text-align: center; "><img src="./img/smart_device.jpg" alt="Deux femmes parlant entre elles avec des bulles de conversation en arrière-plan" width="35%"/></p>

Vous pourriez avoir échangé avec un chatbot pour obtenir de l'aide concernant un produit ou un service.

<p style="text-align: center; "><img src="./img/customer_service_chatbot.png" alt="page d'accueil d'un nouvel utilisateur sur github" width="20%"/></p>
