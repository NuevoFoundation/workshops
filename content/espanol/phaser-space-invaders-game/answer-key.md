```markdown
---
title: "Clave de Respuestas - Juego de Space Invaders con Phaser"
...
create(){
    ...
    // elimina el código anterior de fondo y vuelve a crearlo como un sprite de mosaico
...
playerShoot(){
    ...
    if (Phaser.Input.Keyboard.JustDown(this.spacebar)) {
        if(this.player.active) {
    		...
    		this.projectiles.add(playerBullet); // añadir al grupo
    	}
    }
}
