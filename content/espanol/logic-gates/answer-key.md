...
{{< workshop-image filename="media/answer-1.webp" alt="Solución" width="40%" class="lg-img" >}}
...
{{< workshop-image filename="media/answer-2.webp" alt="Solución" width="40%" class="lg-img" >}}
...
{{< workshop-image filename="media/answer-3.webp" alt="Solución" width="40%" class="lg-img" >}}
...
{{< workshop-image filename="media/answer-4.webp" alt="Solución" width="40%" class="lg-img" >}}
...
{{< workshop-image filename="media/answer-5.webp" alt="Solución" width="40%" class="lg-img" >}}
...
{{< workshop-image filename="media/answer-6.webp" alt="Solución" width="40%" class="lg-img" >}}
...
{{< workshop-image filename="media/answer-7.webp" alt="Solución" width="40%" class="lg-img" >}}
...
{{< workshop-image filename="media/answer-8.webp" alt="Solución" width="40%" class="lg-img" >}}
...
{{< workshop-image filename="media/answer-us.webp" alt="Solución" width="40%" class="lg-img" >}}
