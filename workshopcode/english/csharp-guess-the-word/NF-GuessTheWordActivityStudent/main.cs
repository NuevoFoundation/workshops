...
namespace NuevoFoundation
{
  class GuessTheWordGame
  {
    static void Main(string[] args)
    {
      ...
      string[] wordBank = { "Hola", "Mundo", "Nuevo" };
      ...
      // TODO (ACTIVITY 3.2): Declare three variables:
      // - lives: an integer that stores how many incorrect guesses the player can make before the game is over. You can set how many lives the player starts with.
